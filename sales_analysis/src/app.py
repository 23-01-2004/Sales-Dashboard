...
def update_dashboard(
    ...
    if model is None or prediction_df.empty:
        ml_section = html.Div("Not enough data to make predictions.", style={'color': 'gray'})
    else:
        ml_section = html.Div([
            html.H4("Predicted Profit Using Random Forest", style={'marginTop': '30px'}),
            dash.dash_table.DataTable(
